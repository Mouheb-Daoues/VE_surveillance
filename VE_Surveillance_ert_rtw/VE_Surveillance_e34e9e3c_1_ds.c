 ...
 */
/* VE_Surveillance_e34e9e3c_1_ds.c - body for module VE_Surveillance_e34e9e3c_1_ds */

#include "ne_ds.h"
#include "VE_Surveillance_e34e9e3c_1_ds_obs_all.h"
#include "VE_Surveillance_e34e9e3c_1_ds_obs_act.h"
#include "VE_Surveillance_e34e9e3c_1_ds_obs_exp.h"
#include "VE_Surveillance_e34e9e3c_1_ds_log.h"
#include "VE_Surveillance_e34e9e3c_1_ds_tdxf_p.h"
#include "VE_Surveillance_e34e9e3c_1_ds_a_p.h"
#include "VE_Surveillance_e34e9e3c_1_ds_obs_il.h"
...
#include "VE_Surveillance_e34e9e3c_1_ds.h"
...
static NeEquationData s_equation_data[16] = { { "", 0U, 8,
    ...
    "VE_Surveillance/Capteurs_Physiques/Battery (Table-Based)", 2U, 0U, FALSE,
    1.0, "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "VE_Surveillance/Capteurs_Physiques/Battery (Table-Based)", 2U, 2U, FALSE,
    1.0, "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "VE_Surveillance/Capteurs_Physiques/DC Motor", 2U, 4U, TRUE, 1.0, "1", }, {
    "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "VE_Surveillance/Capteurs_Physiques/DC Motor", 2U, 6U, TRUE, 1.0, "1", }, {
    "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "VE_Surveillance/Capteurs_Physiques/H-Bridge", 5U, 8U, TRUE, 1.0, "1", }, {
    "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "VE_Surveillance/Capteurs_Physiques/Ideal Rotational Motion Sensor", 2U, 13U,
    TRUE, 1.0, "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "VE_Surveillance/Capteurs_Physiques/Inertia", 2U, 15U, TRUE, 1.0, "1", }, {
    "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "VE_Surveillance/Capteurs_Physiques/Battery (Table-Based)", 1U, 17U, FALSE,
    1.0, "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "VE_Surveillance/Capteurs_Physiques/Battery (Table-Based)", 1U, 18U, FALSE,
    1.0, "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "VE_Surveillance/Capteurs_Physiques/Battery (Table-Based)", 1U, 19U, FALSE,
    1.0, "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "VE_Surveillance/Capteurs_Physiques/Battery (Table-Based)", 1U, 20U, FALSE,
    1.0, "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "VE_Surveillance/Capteurs_Physiques/Battery (Table-Based)", 1U, 21U, FALSE,
    1.0, "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "VE_Surveillance/Capteurs_Physiques/Battery (Table-Based)", 1U, 22U, FALSE,
    1.0, "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "VE_Surveillance/Capteurs_Physiques/Controlled PWM Voltage", 1U, 23U, FALSE,
    1.0, "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "VE_Surveillance/Capteurs_Physiques/DC Motor", 1U, 24U, TRUE, 1.0, "1", }, {
    "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "VE_Surveillance/Capteurs_Physiques/H-Bridge", 7U, 25U, FALSE, 1.0, "1", } };

static NeCERData *s_cer_data = NULL;
static NeICRData s_icr_data[5] = { { "", 0U, 0,
...
static NeVariableData s_variable_data[16] = { {
    ...
    "Capteurs_Physiques.DC_Motor.i_L", 0U, 0,
    "VE_Surveillance/Capteurs_Physiques/DC Motor", 1.0, "1", 0.0, TRUE, FALSE,
    1U, 1U, NE_INIT_MODE_MANDATORY, "Current", }, {
    "Capteurs_Physiques.DC_Motor.w", 0U, 0,
    "VE_Surveillance/Capteurs_Physiques/DC Motor", 1.0, "1", 0.0, TRUE, FALSE,
    1U, 1U, NE_INIT_MODE_MANDATORY, "Angular velocity", }, {
    "Capteurs_Physiques.Inertia.w", 0U, 0,
    "VE_Surveillance/Capteurs_Physiques/Inertia", 1.0, "1", 0.0, TRUE, FALSE, 1U,
    1U, NE_INIT_MODE_MANDATORY, "Rotational velocity", }, {
    "Capteurs_Physiques.H_Bridge.v_lag", 0U, 0,
    "VE_Surveillance/Capteurs_Physiques/H-Bridge", 1.0, "1", 0.0, TRUE, FALSE,
    1U, 1U, NE_INIT_MODE_MANDATORY, "Lag variable", }, {
    ...
    "Capteurs_Physiques.Battery_Table_Based.xGsd", 0U, 0,
    "VE_Surveillance/Capteurs_Physiques/Battery (Table-Based)", 1.0, "1", 0.0,
    FALSE, FALSE, 1U, 1U, NE_INIT_MODE_NONE, "1/Rleak(T,N)", }, {
    ...
    "Capteurs_Physiques.Battery_Table_Based.xRleak", 0U, 0,
    "VE_Surveillance/Capteurs_Physiques/Battery (Table-Based)", 1.0, "1", 0.0,
    FALSE, FALSE, 1U, 1U, NE_INIT_MODE_NONE,
    "Faded and temperature adjusted self-discharge resistance", }, {
    "Capteurs_Physiques.Battery_Table_Based.xqnom", 0U, 0,
    "VE_Surveillance/Capteurs_Physiques/Battery (Table-Based)", 1.0, "1", 0.0,
    FALSE, FALSE, 1U, 1U, NE_INIT_MODE_NONE,
    "Faded and temperature adjusted ampere-hour rating", }, {
    "Capteurs_Physiques.Controlled_PWM_Voltage.p2.v", 0U, 1,
    "VE_Surveillance/Capteurs_Physiques/Controlled PWM Voltage", 1.0, "1", 0.0,
    FALSE, FALSE, 1U, 1U, NE_INIT_MODE_NONE, "Voltage", }, {
    "Capteurs_Physiques.DC_Motor.v", 0U, 0,
    "VE_Surveillance/Capteurs_Physiques/DC Motor", 1.0, "1", 0.0, FALSE, FALSE,
    1U, 1U, NE_INIT_MODE_NONE, "Voltage", }, { "Capteurs_Physiques.Inertia.t",
    0U, 0, "VE_Surveillance/Capteurs_Physiques/Inertia", 1.0, "1", 0.0, FALSE,
    FALSE, 1U, 1U, NE_INIT_MODE_NONE, "Torque", } };

static NeVariableData *s_discrete_data = NULL;
static NeObservableData s_observable_data[98] = { {
    ...
    "VE_Surveillance/Capteurs_Physiques/Battery (Table-Based)", 1U, 1U, "1/Ohm",
    1.0, "s*C^2/m^2/kg", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE,
    ...
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE,
    "Faded and temperature adjusted ampere-hour rating", }, {
    "Capteurs_Physiques.Battery_Table_Based.xRleak",
    "VE_Surveillance/Capteurs_Physiques/Battery (Table-Based)", 1U, 1U, "Ohm",
    1.0, "m^2*kg/s/C^2", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, FALSE, TRUE,
    "Faded and temperature adjusted self-discharge resistance", }, {
    "Capteurs_Physiques.Controlled_PWM_Voltage.i1",
    "VE_Surveillance/Capteurs_Physiques/Controlled PWM Voltage", 1U, 1U, "A",
    1.0, "A", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Input current", }, {
    "Capteurs_Physiques.Controlled_PWM_Voltage.n1.v",
    "VE_Surveillance/Capteurs_Physiques/Controlled PWM Voltage", 1U, 1U, "V",
    1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Capteurs_Physiques.Controlled_PWM_Voltage.n2.v",
    "VE_Surveillance/Capteurs_Physiques/Controlled PWM Voltage", 1U, 1U, "V",
    1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Capteurs_Physiques.Controlled_PWM_Voltage.p1.v",
    "VE_Surveillance/Capteurs_Physiques/Controlled PWM Voltage", 1U, 1U, "V",
    1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Capteurs_Physiques.Controlled_PWM_Voltage.p2.v",
    "VE_Surveillance/Capteurs_Physiques/Controlled PWM Voltage", 1U, 1U, "V",
    1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Capteurs_Physiques.Controlled_PWM_Voltage.pwm.duty_cycle",
    "VE_Surveillance/Capteurs_Physiques/Controlled PWM Voltage", 1U, 1U, "1",
    1.0, "1", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Duty cycle", }, {
    "Capteurs_Physiques.Controlled_PWM_Voltage.pwm.i2",
    "VE_Surveillance/Capteurs_Physiques/Controlled PWM Voltage", 1U, 1U, "A",
    1.0, "A", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Output current", }, {
    "Capteurs_Physiques.Controlled_PWM_Voltage.pwm.n2.v",
    "VE_Surveillance/Capteurs_Physiques/Controlled PWM Voltage", 1U, 1U, "V",
    1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Capteurs_Physiques.Controlled_PWM_Voltage.pwm.p2.v",
    "VE_Surveillance/Capteurs_Physiques/Controlled PWM Voltage", 1U, 1U, "V",
    1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Capteurs_Physiques.Controlled_PWM_Voltage.pwm.v2",
    "VE_Surveillance/Capteurs_Physiques/Controlled PWM Voltage", 1U, 1U, "V",
    1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    ...
    "Capteurs_Physiques.DC_Motor.C.w",
    "VE_Surveillance/Capteurs_Physiques/DC Motor", 1U, 1U, "rad/s", 1.0, "1/s",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Capteurs_Physiques.DC_Motor.R.w",
    "VE_Surveillance/Capteurs_Physiques/DC Motor", 1U, 1U, "rad/s", 1.0, "1/s",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Capteurs_Physiques.DC_Motor.armature_winding_fault_factor",
    "VE_Surveillance/Capteurs_Physiques/DC Motor", 1U, 1U, "1", 1.0, "1",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE,
    "Armature winding fault resistance correction factor ( closed = 1, open = 1/(G_faulted_armature*x_Ra) )",
  }, { "Capteurs_Physiques.DC_Motor.field_winding_fault_factor",
    "VE_Surveillance/Capteurs_Physiques/DC Motor", 1U, 1U, "1", 1.0, "1",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE,
    "Field winding fault resistance correction factor ( closed = 1, open = 1/(G_faulted_field*Rf) )",
  }, { "Capteurs_Physiques.DC_Motor.fn.v",
    "VE_Surveillance/Capteurs_Physiques/DC Motor", 1U, 1U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Voltage", }, {
    "Capteurs_Physiques.DC_Motor.fp.v",
    "VE_Surveillance/Capteurs_Physiques/DC Motor", 1U, 1U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Voltage", }, {
    "Capteurs_Physiques.DC_Motor.ground_not_used.V.v",
    "VE_Surveillance/Capteurs_Physiques/DC Motor", 1U, 1U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Voltage", }, {
    "Capteurs_Physiques.DC_Motor.i",
    "VE_Surveillance/Capteurs_Physiques/DC Motor", 1U, 1U, "A", 1.0, "A",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Armature current", }, {
    "Capteurs_Physiques.DC_Motor.i_L",
    "VE_Surveillance/Capteurs_Physiques/DC Motor", 1U, 1U, "A", 1.0, "A",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_MANDATORY, FALSE, TRUE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Current", }, {
    "Capteurs_Physiques.DC_Motor.n.v",
    "VE_Surveillance/Capteurs_Physiques/DC Motor", 1U, 1U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Capteurs_Physiques.DC_Motor.p.v",
    "VE_Surveillance/Capteurs_Physiques/DC Motor", 1U, 1U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Capteurs_Physiques.DC_Motor.power_dissipated",
    "VE_Surveillance/Capteurs_Physiques/DC Motor", 1U, 1U, "W", 1.0, "kW",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Power dissipated", }, {
    "Capteurs_Physiques.DC_Motor.t",
    "VE_Surveillance/Capteurs_Physiques/DC Motor", 1U, 1U, "N*m", 1.0, "N*m",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Torque", }, {
    "Capteurs_Physiques.DC_Motor.v",
    "VE_Surveillance/Capteurs_Physiques/DC Motor", 1U, 1U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Capteurs_Physiques.DC_Motor.v_f",
    "VE_Surveillance/Capteurs_Physiques/DC Motor", 1U, 1U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Field voltage", }, {
    "Capteurs_Physiques.DC_Motor.w",
    "VE_Surveillance/Capteurs_Physiques/DC Motor", 1U, 1U, "rpm", 1.0, "1/s",
    ...
    "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Capteurs_Physiques.H_Bridge.BRK.v",
    "VE_Surveillance/Capteurs_Physiques/H-Bridge", 1U, 1U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Capteurs_Physiques.H_Bridge.ENA.v",
    "VE_Surveillance/Capteurs_Physiques/H-Bridge", 1U, 1U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Capteurs_Physiques.H_Bridge.REF.v",
    "VE_Surveillance/Capteurs_Physiques/H-Bridge", 1U, 1U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Capteurs_Physiques.H_Bridge.REV.v",
    "VE_Surveillance/Capteurs_Physiques/H-Bridge", 1U, 1U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Capteurs_Physiques.H_Bridge.i2",
    "VE_Surveillance/Capteurs_Physiques/H-Bridge", 1U, 1U, "A", 1.0, "A",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Current (+ -> -)", }, {
    "Capteurs_Physiques.H_Bridge.iBRK",
    "VE_Surveillance/Capteurs_Physiques/H-Bridge", 1U, 1U, "A", 1.0, "A",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Current (BRK -> REF)", }, {
    "Capteurs_Physiques.H_Bridge.iENA",
    "VE_Surveillance/Capteurs_Physiques/H-Bridge", 1U, 1U, "A", 1.0, "A",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Current (ENA -> REF)", }, {
    "Capteurs_Physiques.H_Bridge.iREV",
    "VE_Surveillance/Capteurs_Physiques/H-Bridge", 1U, 1U, "A", 1.0, "A",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Current (REV -> REF)", }, {
    "Capteurs_Physiques.H_Bridge.n1.v",
    "VE_Surveillance/Capteurs_Physiques/H-Bridge", 1U, 1U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Voltage", }, {
    "Capteurs_Physiques.H_Bridge.n2.v",
    "VE_Surveillance/Capteurs_Physiques/H-Bridge", 1U, 1U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Capteurs_Physiques.H_Bridge.p1.v",
    "VE_Surveillance/Capteurs_Physiques/H-Bridge", 1U, 1U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Voltage", }, {
    "Capteurs_Physiques.H_Bridge.p2.v",
    "VE_Surveillance/Capteurs_Physiques/H-Bridge", 1U, 1U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Capteurs_Physiques.H_Bridge.power_dissipated",
    "VE_Surveillance/Capteurs_Physiques/H-Bridge", 1U, 1U, "W", 1.0, "kW",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Power dissipated", }, {
    "Capteurs_Physiques.H_Bridge.v2",
    "VE_Surveillance/Capteurs_Physiques/H-Bridge", 1U, 1U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Output voltage", }, {
    "Capteurs_Physiques.H_Bridge.v_lag",
    "VE_Surveillance/Capteurs_Physiques/H-Bridge", 1U, 1U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_MANDATORY, FALSE, TRUE,
    ...
    "Capteurs_Physiques.Ideal_Torque_Source.C.w",
    "VE_Surveillance/Capteurs_Physiques/Ideal Torque Source", 1U, 1U, "rad/s",
    1.0, "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Capteurs_Physiques.Ideal_Torque_Source.R.w",
    "VE_Surveillance/Capteurs_Physiques/Ideal Torque Source", 1U, 1U, "rad/s",
    1.0, "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Capteurs_Physiques.Ideal_Torque_Source.S",
    "VE_Surveillance/Capteurs_Physiques/Ideal Torque Source", 1U, 1U, "N*m", 1.0,
    "N*m", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "S", }, {
    "Capteurs_Physiques.Ideal_Torque_Source.t",
    "VE_Surveillance/Capteurs_Physiques/Ideal Torque Source", 1U, 1U, "N*m", 1.0,
    "N*m", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Torque", }, {
    "Capteurs_Physiques.Ideal_Torque_Source.w",
    "VE_Surveillance/Capteurs_Physiques/Ideal Torque Source", 1U, 1U, "rad/s",
    1.0, "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Angular velocity", }, {
    "Capteurs_Physiques.Inertia.I.w",
    "VE_Surveillance/Capteurs_Physiques/Inertia", 1U, 1U, "rad/s", 1.0, "1/s",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Capteurs_Physiques.Inertia.J.w",
    "VE_Surveillance/Capteurs_Physiques/Inertia", 1U, 1U, "rad/s", 1.0, "1/s",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Rotational velocity", }, {
    "Capteurs_Physiques.Inertia.t", "VE_Surveillance/Capteurs_Physiques/Inertia",
    1U, 1U, "N*m", 1.0, "N*m", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Torque", }, {
    "Capteurs_Physiques.Inertia.w", "VE_Surveillance/Capteurs_Physiques/Inertia",
    ...
    "rad/s", 1.0, "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Capteurs_Physiques.Rotational_Damper.C.w",
    "VE_Surveillance/Capteurs_Physiques/Rotational Damper", 1U, 1U, "rad/s", 1.0,
    "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Capteurs_Physiques.Rotational_Damper.R.w",
    "VE_Surveillance/Capteurs_Physiques/Rotational Damper", 1U, 1U, "rad/s", 1.0,
    "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Capteurs_Physiques.Rotational_Damper.t",
    "VE_Surveillance/Capteurs_Physiques/Rotational Damper", 1U, 1U, "N*m", 1.0,
    "N*m", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Torque", }, {
    "Capteurs_Physiques.Rotational_Damper.w",
    "VE_Surveillance/Capteurs_Physiques/Rotational Damper", 1U, 1U, "rad/s", 1.0,
    "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Angular velocity", }, {
    "Capteurs_Physiques.Simulink_PS_Converter_output",
    "VE_Surveillance/Capteurs_Physiques", 1U, 1U, "N*m", 1.0, "N*m",
    ...
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Capteurs_Physiques.Voltage_Sensor1.V",
    "VE_Surveillance/Capteurs_Physiques/Voltage Sensor1", 1U, 1U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "V", }, {
    "Capteurs_Physiques.Voltage_Sensor1.n.v",
    "VE_Surveillance/Capteurs_Physiques/Voltage Sensor1", 1U, 1U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Capteurs_Physiques.Voltage_Sensor1.p.v",
    "VE_Surveillance/Capteurs_Physiques/Voltage Sensor1", 1U, 1U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Capteurs_Physiques.Voltage_Sensor1_V", "VE_Surveillance/Capteurs_Physiques",
    1U, 1U, "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Voltage_Sensor1_V", } };
...
static NeZCData s_zc_data[6] = { {
    ...
    "Capteurs_Physiques.Battery_Table_Based",
    "C:/Program Files/Polyspace/R2021a/toolbox/physmod/elec/library/m/+ee/+sources/table_battery.sscp",
    NE_ZC_TYPE_FALSE, }, { "VE_Surveillance/Capteurs_Physiques/H-Bridge", 1U, 5U,
    "Capteurs_Physiques.H_Bridge",
    "C:/Program Files/Polyspace/R2021a/toolbox/physmod/elec/library/m/+ee/+semiconductors/+converters/h_bridge.sscp",
    NE_ZC_TYPE_TRUE, } };
...
static NeAssertData s_assert_data[20] = { {
    "VE_Surveillance/Capteurs_Physiques/Battery (Table-Based)", 1U, 0U,
    "Capteurs_Physiques.Battery_Table_Based",
    "C:/Program Files/Polyspace/R2021a/toolbox/physmod/elec/library/m/+ee/+sources/table_battery.sscp",
    FALSE,
    ...
    "C:/Program Files/Polyspace/R2021a/toolbox/physmod/elec/library/m/+ee/+sources/table_battery.sscp",
    FALSE,
    "Faded and temperature adjusted self-discharge resistance must be greater than zero.",
    "physmod:simscape:compiler:patterns:checks:GreaterThanZero", }, {
    ...
    "VE_Surveillance/Capteurs_Physiques/DC Motor", 1U, 7U,
    "Capteurs_Physiques.DC_Motor",
    "C:/Program Files/Polyspace/R2021a/toolbox/physmod/elec/library/m/+ee/+electromech/+brushed/dc_motor.sscp",
    FALSE,
    "In power, the exponent must be positive when the base is equal to zero.",
    "physmod:common:mf:expr:analyze:RequireExponentPositive", }, {
    "VE_Surveillance/Capteurs_Physiques/DC Motor", 1U, 8U,
    "Capteurs_Physiques.DC_Motor",
    "C:/Program Files/Polyspace/R2021a/toolbox/physmod/elec/library/m/+ee/+electromech/+brushed/dc_motor.sscp",
    FALSE,
    "In power, the base must be nonnegative when the exponent is not an integer.",
    "physmod:common:mf:expr:analyze:RequireBaseNonnegative", }, {
    "VE_Surveillance/Capteurs_Physiques/H-Bridge", 1U, 9U,
    "Capteurs_Physiques.H_Bridge",
    "C:/Program Files/Polyspace/R2021a/toolbox/physmod/elec/library/m/+ee/+semiconductors/+converters/h_bridge.sscp",
    FALSE,
    "In power, the exponent must be positive when the base is equal to zero.",
    "physmod:common:mf:expr:analyze:RequireExponentPositive", }, {
    "VE_Surveillance/Capteurs_Physiques/H-Bridge", 1U, 10U,
    "Capteurs_Physiques.H_Bridge",
    "C:/Program Files/Polyspace/R2021a/toolbox/physmod/elec/library/m/+ee/+semiconductors/+converters/h_bridge.sscp",
    FALSE,
    "In power, the base must be nonnegative when the exponent is not an integer.",
    "physmod:common:mf:expr:analyze:RequireBaseNonnegative", }, {
    "VE_Surveillance/Capteurs_Physiques/Controlled PWM Voltage", 1U, 11U,
    "Capteurs_Physiques.Controlled_PWM_Voltage",
    "C:/Program Files/Polyspace/R2021a/toolbox/physmod/elec/library/m/+ee/+ic/controlled_pwm.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:expr:analyze:RequireDenominatorNonzero", }, {
    "VE_Surveillance/Capteurs_Physiques/H-Bridge", 1U, 12U,
    "Capteurs_Physiques.H_Bridge",
    "C:/Program Files/Polyspace/R2021a/toolbox/physmod/elec/library/m/+ee/+semiconductors/+converters/h_bridge.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:expr:analyze:RequireDenominatorNonzero", }, {
    "VE_Surveillance/Capteurs_Physiques/Battery (Table-Based)", 1U, 13U,
    "Capteurs_Physiques.Battery_Table_Based",
    "C:/Program Files/Polyspace/R2021a/toolbox/physmod/elec/library/m/+ee/+sources/table_battery.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:expr:analyze:RequireDenominatorNonzero", }, {
    ...
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:expr:analyze:RequireDenominatorNonzero", }, {
    "VE_Surveillance/Capteurs_Physiques/Battery (Table-Based)", 1U, 18U,
    "Capteurs_Physiques.Battery_Table_Based",
    "C:/Program Files/Polyspace/R2021a/toolbox/physmod/elec/library/m/+ee/+sources/table_battery.sscp",
    FALSE, "Argument of sqrt must be nonnegative.",
    "physmod:common:mf:expr:analyze:RequireArgumentNonnegative", }, {
    "VE_Surveillance/Capteurs_Physiques/H-Bridge", 1U, 19U,
    "Capteurs_Physiques.H_Bridge",
    "C:/Program Files/Polyspace/R2021a/toolbox/physmod/elec/library/m/+ee/+semiconductors/+converters/h_bridge.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:expr:analyze:RequireDenominatorNonzero", } };

static NeRange s_assert_range[20] = { {
    "C:/Program Files/Polyspace/R2021a/toolbox/physmod/elec/library/m/+ee/+sources/table_battery.sscp",
    1U, 1U, 1U, 1U, NE_RANGE_TYPE_PROTECTED, }, {
    "C:/Program Files/Polyspace/R2021a/toolbox/physmod/elec/library/m/+ee/+sources/table_battery.sscp",
    1U, 1U, 1U, 1U, NE_RANGE_TYPE_PROTECTED, }, {
...
static NeRange s_equation_range[32] = { {
    "C:/Program Files/Polyspace/R2021a/toolbox/physmod/elec/library/m/+ee/+sources/table_battery.sscp",
    1U, 1U, 1U, 1U, NE_RANGE_TYPE_PROTECTED, }, {
    "C:/Program Files/Polyspace/R2021a/toolbox/physmod/elec/library/m/+ee/+sources/table_battery.sscp",
    1U, 1U, 1U, 1U, NE_RANGE_TYPE_PROTECTED, }, {
    ...
    "C:/Program Files/Polyspace/R2021a/toolbox/physmod/simscape/library/m/+foundation/+mechanical/+rotational/inertia.ssc",
...
static real_T s_constant_table0[18] = { 340.0, 355.0, 368.0, 380.0, 392.0, 400.0,
  345.0, 360.0, 373.0, 385.0, 397.0, 405.0, 342.0, 357.0, 370.0, 382.0, 394.0,
  402.0 };

static real_T s_constant_table1[18] = { 0.08, 0.06, 0.05, 0.04, 0.04, 0.05, 0.06,
  ...
  *allocator)
{
  ...
  out = (NeDsMethodOutput *) allocator->mCallocFcn(allocator, sizeof
    (NeDsMethodOutput), 1);
  out->mA.mN = 23;
  out->mA.mX = (real_T *) allocator->mCallocFcn(allocator, sizeof(real_T), 23);
  return out;
}
  ...
  *allocator)
{
  ...
  out = (NeDsMethodOutput *) allocator->mCallocFcn(allocator, sizeof
    (NeDsMethodOutput), 1);
  out->mDXF.mN = 17;
  out->mDXF.mX = (real_T *) allocator->mCallocFcn(allocator, sizeof(real_T), 17);
  return out;
}
  ...
  *allocator)
{
  ...
  out = (NeDsMethodOutput *) allocator->mCallocFcn(allocator, sizeof
    (NeDsMethodOutput), 1);
  out->mLOG.mN = 98;
  out->mLOG.mX = (real_T *) allocator->mCallocFcn(allocator, sizeof(real_T), 98);
  return out;
}
...
NeDynamicSystem *VE_Surveillance_e34e9e3c_1_dae_ds(PmAllocator *allocator)
{
  NeDynamicSystem *ds;
  _NeDynamicSystem *_ds;
  ...
  input_info[0].mIdentifier = "Capteurs_Physiques.Simulink_PS_Converter_output";
  input_info[0].mM = 1;
  input_info[0].mN = 1;
  input_info[0].mName = "Capteurs_Physiques.Simulink_PS_Converter_output";
  ...
  output_info[2].mIdentifier = "Capteurs_Physiques.Voltage_Sensor1_V";
  output_info[2].mM = 1;
  output_info[2].mN = 1;
  output_info[2].mName = "Capteurs_Physiques.Voltage_Sensor1_V";
  ...
  ds->mMethods[NE_DS_METHOD_A_P] = VE_Surveillance_e34e9e3c_1_ds_a_p;
  ds->mMakeOutput[NE_DS_METHOD_A_P] = ds_output_a_p;
  ds->mMethods[NE_DS_METHOD_A] = VE_Surveillance_e34e9e3c_1_ds_a;
  ...
  ds->mMethods[NE_DS_METHOD_F] = VE_Surveillance_e34e9e3c_1_ds_f;
  ...
  ds->mMethods[NE_DS_METHOD_DXF] = VE_Surveillance_e34e9e3c_1_ds_dxf;
  ...
  ds->mMethods[NE_DS_METHOD_TDXF_P] = VE_Surveillance_e34e9e3c_1_ds_tdxf_p;
  ...
  ds->mMethods[NE_DS_METHOD_LOG] = VE_Surveillance_e34e9e3c_1_ds_log;
  ds->mMakeOutput[NE_DS_METHOD_LOG] = ds_output_log;
  ds->mMethods[NE_DS_METHOD_ASSERT] = VE_Surveillance_e34e9e3c_1_ds_assert;
  ...
  ds->mMethods[NE_DS_METHOD_OBS_EXP] = VE_Surveillance_e34e9e3c_1_ds_obs_exp;
  ds->mMakeOutput[NE_DS_METHOD_OBS_EXP] = ds_output_obs_exp;
  ds->mMethods[NE_DS_METHOD_OBS_ACT] = VE_Surveillance_e34e9e3c_1_ds_obs_act;
  ds->mMakeOutput[NE_DS_METHOD_OBS_ACT] = ds_output_obs_act;
  ds->mMethods[NE_DS_METHOD_OBS_ALL] = VE_Surveillance_e34e9e3c_1_ds_obs_all;
  ds->mMakeOutput[NE_DS_METHOD_OBS_ALL] = ds_output_obs_all;
  ds->mMethods[NE_DS_METHOD_OBS_IL] = VE_Surveillance_e34e9e3c_1_ds_obs_il;
  ...
  *t1, NeDsMethodOutput *t2)
{
  ...
  out = t2->mMODE;
  out.mX[0] = (int32_T)(X_idx_13 <= 5.0);
  out.mX[1] = (int32_T)(X_idx_12 > 0.0);
  out.mX[2] = (int32_T)(X_idx_7 >= 0.0);
  out.mX[3] = (int32_T)(X_idx_9 > 0.0);
  out.mX[4] = (int32_T)(X_idx_10 >= 0.0);
  out.mX[5] = (int32_T)(X_idx_11 > 0.0);
  (void)LC;
  (void)t2;
  return 0;
}
                     ...
                     NeDsMethodOutput *t3)
{
  ...
  out = t3->mY;
  out.mX[0] = (X_idx_2 * 0.99999999995 + X_idx_3 * -4.7746482925181279E-10) +
    X_idx_14 * 9.9999999995E-10;
  out.mX[1] = X_idx_4;
  out.mX[2] = -X_idx_14 / -1.0;
  (void)LC;
  (void)t3;
  return 0;
}
  ...
  NeDsMethodOutput *t2)
{
  ...
  (void)LC;
  out = t2->mDXY;
  out.mX[0] = 0.99999999995;
  out.mX[1] = -4.7746482925181279E-10;
  out.mX[2] = 1.0;
  out.mX[3] = 9.9999999995E-10;
  out.mX[4] = 1.0;
  (void)LC;
  (void)t2;
  return 0;
