...
int32_T VE_Surveillance_48324b08_1_ds_zc(const NeDynamicSystem *LC, const
  NeDynamicSystemInput *t1, NeDsMethodOutput *t2)
{
  ...
  out.mX[2] = X_idx_11;
  out.mX[3] = X_idx_12;
  out.mX[4] = X_idx_14 - 6.0;
  out.mX[5] = X_idx_15 - 6.0;
  out.mX[6] = X_idx_16 - 6.0;
  out.mX[7] = X_idx_17 - 6.0;
  out.mX[8] = X_idx_18 - 6.0;
  out.mX[9] = X_idx_19 - 6.0;
  (void)LC;
  (void)t2;
  return 0;
}
